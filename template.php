 ...
 */
function obiba_bootswatch_theme($existing, $type, $theme, $path) {
  $theme_array = array();
  ...
  if (!empty($destination_path)) {
    $theme_array['user_login'] = array(
      ...
      'preprocess functions' => array(
        'obiba_bootswatch_preprocess_user_login',
      ),
    );
  }
  ...
  if (!empty($destination_path)) {
    $theme_array['user_register_form'] = array(
      ...
      'render element' => 'form',
      'preprocess functions' => array(
        'obiba_bootswatch_preprocess_user_register_form',
      ),
    );
  }
  ...
  if (!empty($destination_path)) {
    $theme_array['user_pass'] = array(
      ...
      'render element' => 'form',
      'preprocess functions' => array(
        'obiba_bootswatch_preprocess_user_pass',
      ),
    );
  }
 ...
 */
function obiba_bootswatch_bootstrap_based_theme() {
  return array('obiba_bootswatch' => TRUE);
}

/**
 * Implements hook_preprocess_html().
 */
function obiba_bootswatch_preprocess_html(&$variables) {
  $cdn_setting = theme_get_setting('bootstrap_cdn_provider', 'obiba_bootswatch');
 ...
 *   The first letter.
 */
function obiba_bootswatch_letters_badge_title() {
 ...
 * @see page.tpl.php
 */
function obiba_bootswatch_preprocess_page(&$variables) {
  // Add badge letter.
  $first_letter_title = obiba_bootswatch_letters_badge_title();
  ...
  $cdn_setting = theme_get_setting('bootstrap_cdn_provider', 'obiba_bootswatch');
  if (empty($cdn_setting)) {
    drupal_add_js(drupal_get_path('theme', 'obiba_bootswatch') . '/bootstrap/js/bootstrap.js');
  }
  ...
  $variables['profile_path'] = obiba_bootswatch_get_user_profile_page();
}
 ...
 *   The Profile path.
 */
function obiba_bootswatch_get_user_profile_page() {
  global $user;
  if (!empty($user->name)) {
 ...
 */
function obiba_bootswatch_menu_local_action($variables) {
